  ...
  return (
    <Container maxWidth="sm" sx={{ py: 6 }}>
      <AnimatedSection sx={{ p: 2, mb: 2, background: (t) => t.palette.mode === 'light' ? 'rgba(255,255,255,0.6)' : 'rgba(17,24,39,0.5)' }}>
        <Typography variant="h4" sx={{ fontWeight: 700, mb: 1 }}>Create your account</Typography>
        <Typography variant="body2" color="text.secondary">Sign up to start practicing interviews.</Typography>
      </AnimatedSection>
      <Paper
        sx={{
          p: 4,
